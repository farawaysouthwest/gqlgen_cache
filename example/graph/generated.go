...
type ComplexityRoot struct {
	...
	Query struct {
		Todos func(childComplexity int, test *string) int
	}
...
type QueryResolver interface {
	Todos(ctx context.Context, test *string) ([]*model.Todo, error)
}
type TodoResolver interface {
	Text(ctx context.Context, obj *model.Todo) (string, error)
...
func (e *executableSchema) Complexity(typeName, field string, childComplexity int, rawArgs map[string]interface{}) (int, bool) {
	...
	case "Query.todos":
		...
		return e.complexity.Query.Todos(childComplexity, args["test"].(*string)), true
...
func (ec *executionContext) field_Query_todos_args(ctx context.Context, rawArgs map[string]interface{}) (map[string]interface{}, error) {
	var err error
	args := map[string]interface{}{}
	arg0, err := ec.field_Query_todos_argsTest(ctx, rawArgs)
	if err != nil {
		return nil, err
	}
	args["test"] = arg0
...
func (ec *executionContext) field_Query_todos_argsTest(
	ctx context.Context,
	rawArgs map[string]interface{},
) (*string, error) {
...
func (ec *executionContext) _Query_todos(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		directive0 := func(rctx context.Context) (interface{}, error) {
			ctx = rctx // use context from middleware stack in children
			return ec.resolvers.Query().Todos(rctx, fc.Args["test"].(*string))
		}

		directive1 := func(ctx context.Context) (interface{}, error) {
			maxAge, err := ec.unmarshalOInt2ᚖint(ctx, 10)
			if err != nil {
			...
			return ec.directives.CacheControl(ctx, nil, directive0, maxAge)
		}
...
func (ec *executionContext) _Todo_user(ctx context.Context, field graphql.CollectedField, obj *model.Todo) (ret graphql.Marshaler) {
	...
	fc.Result = res
	return ec.marshalNUser2ᚖgithubᚗcomᚋfarawaysouthwestᚋgqlgen_cacheᚋexampleᚋgraphᚋmodelᚐUser(ctx, field.Selections, res)
}
...
func (ec *executionContext) marshalNUser2githubᚗcomᚋfarawaysouthwestᚋgqlgen_cacheᚋexampleᚋgraphᚋmodelᚐUser(ctx context.Context, sel ast.SelectionSet, v model.User) graphql.Marshaler {
	return ec._User(ctx, sel, &v)
}

func (ec *executionContext) marshalNUser2ᚖgithubᚗcomᚋfarawaysouthwestᚋgqlgen_cacheᚋexampleᚋgraphᚋmodelᚐUser(ctx context.Context, sel ast.SelectionSet, v *model.User) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			ec.Errorf(ctx, "the requested element is null which the schema does not allow")
		}
